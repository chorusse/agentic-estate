...
searched-up file — text, same channel. The model weighs all of it (lesson 2) with no
...
**Teach:** anything fetched — web, file, recall — is internet-zone traffic: cite it, never
