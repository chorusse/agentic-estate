...
1. **Every table ends with an explicit escalate-don't-guess row.** The classifier must have a
   ...
   charters in lesson 4 — "when unsure, ask" — this is that clause, at the routing layer, as
...
force-fitting novel requests into familiar machinery — you just haven't seen it, which is the
