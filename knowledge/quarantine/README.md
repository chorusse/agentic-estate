...
Nothing in this directory is ever read by the estate. Not "shouldn't be" — *can't be*: the
...
The teaching point is the pairing. `CLAUDE.md` *declares* the quarantine (policy — the model
