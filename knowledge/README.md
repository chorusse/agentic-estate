...
| Tier | Here | Rule |
|---|---|---|
| **Resident** | `resident/` | Loaded every session. Kept tiny on purpose — everything resident competes for the model's attention on every single turn, relevant or not. Audit it like you'd audit what runs as root. |
